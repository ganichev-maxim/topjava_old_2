...
@NamedQueries({
        ...
        @NamedQuery(name = Meal.BETWEEN, query = "SELECT m FROM Meal m WHERE m.user.id = :user_id and m.dateTime between :startDateTime and :endDateTime ORDER BY m.dateTime DESC"),
})
@Entity
